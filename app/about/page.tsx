...
export const metadata: Metadata = {
  ...
  description:
    'Learn about OpenMind Events — the organization behind world-class forums and conferences for senior HR and business leaders.',
};
...
const values = [
  ...
  },
  {
    ...
    description:
      'Our forums draw speakers and delegates from across Asia-Pacific, North America, Europe, and the Middle East. Global challenges require global dialogue.',
  },
  {
    icon: Award,
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-700 text-lg font-light leading-relaxed mb-4">
              OpenMind Events produces premium forums, conferences, and
